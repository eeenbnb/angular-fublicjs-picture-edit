...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onChangeInput = function (e) {
        var _this = this;
        ...
        reader.onload = (function (file) {
            return function (e) {
                ...
                image.onload = function () {
                    var fabricImage = new fabric__WEBPACK_IMPORTED_MODULE_1__["fabric"].Image(image);
                    fabricImage.set({
                        selectable: false,
                        width: fabricImage.width,
                        height: fabricImage.height
                    });
                    _this.canvas.setWidth(fabricImage.width);
                    _this.canvas.setHeight(fabricImage.height);
                    _this.canvas.clear();
                    _this.canvas.add(fabricImage);
                };
    ...
    AppComponent.prototype.addSticker = function (i) {
        var _this = this;
        var image = new Image;
        image.onload = function () {
            var fabricImage = new fabric__WEBPACK_IMPORTED_MODULE_1__["fabric"].Image(image);
    ...
    AppComponent.prototype.canvasToImg = function () {
    ...
    ], AppComponent.prototype, "previewElement", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("canvas"),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], AppComponent.prototype, "canvasElement", void 0);
...
module.exports = __webpack_require__(/*! /Users/eee/Desktop/work/angular-fublicjs-picture-edit/src/main.ts */"./src/main.ts");
